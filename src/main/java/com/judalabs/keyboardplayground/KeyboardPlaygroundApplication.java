...
import com.judalabs.keyboardplayground.corpus.CorpusStats;
import com.judalabs.keyboardplayground.corpus.Language;
...
@Slf4j
public class KeyboardPlaygroundApplication implements CommandLineRunner {

	public static void main(String[] args) {
		SpringApplication.run(KeyboardPlaygroundApplication.class, args);
	}
	...
	public void run(String... args) {
		...
		final List<LayoutKey> keyCodes = DefaultLayout.build().getKeyCodes();

		final CorpusStatsCollector statsCollector = corpus.chars()
				.collect(() -> new CorpusStatsCollector(keyCodes), CorpusStatsCollector::receive, (a, b) -> {});
